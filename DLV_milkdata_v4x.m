function OUT = DLV_milkdata_v4x(cd,FN_BA,FN_ALS,FN_SMY,FN_VMY)
...
% % % % FN_BA = 'DB1_BasicAnimal';
% % % % FN_ALS = 'DB1_HistoryLactationInfo';
% % % % FN_SMY = 'DB1_SessionMilkYield';
% % % % FN_VMY = 'DB1_VSMY';
% % clear variables
% % clc
% % cd = 'D:\SQL databases\DLV_Biebuyck_Deconinck\';
% % FN_BA = 'F5DB3_BA';
% % FN_ALS = 'F5DB3_HALI';
% % FN_SMY = 'F5DB3_SMY';
% % FN_VMY = 'F5DB3_VMY';
